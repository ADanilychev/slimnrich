...
import './groupForTimeWidget.scss';

const currentConfig = BattleConfig[BattleType.GROUP_FOR_TIME];

export function GroupForTimeWidget({ entity }: { entity?: IBattleInfo }) {
    const t = useTranslations('GroupForTimeWidget');
    const tBattleConfig = useTranslations('BattleConfig.' + BattleType.GROUP_FOR_TIME);
    ...
    return (
        <div className={`battle-widget group-for-time-widget battle-status_${currentStatus}`}>
            <div className="group-for-time-widget__top">
            ...
            <div className="group-for-time-widget__controls">
                {currentStatus === BattleStatusEnum.NEW && (
                    <Button
                        variant={'orange'}
